...
export const IntensiveProgram = () => (
  <section id="intensive-program" className="bg-black text-white">
    <div className="bg-[url('/images/academy/intensive-program.png')] bg-no-repeat bg-cover bg-right max-md:bg-bottom max-lg:bg-left">
      <div className="text-lg max-w-[740px] mx-auto py-20 flex flex-col gap-3 max-md:mx-6 max-lg:mx-12">
        <Image
          ...
          className="mb-6"
        />
        <p className="font-medium text-base text-[#ffffff99]">
          Olas Dev Academy
        </p>
        ...
        <p className="mb-6">
          ...
          <br />
          Participation is by invite only, ensuring a focused and committed
          group of learners. If you meet the requirements and are interested in
          this opportunity, show your interest by filling out the form.
        </p>
